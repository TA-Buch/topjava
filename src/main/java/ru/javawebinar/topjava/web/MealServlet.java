...
public class MealServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        mealController.createOrUpdate(meal);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action == null ? "all" : action) {
            ...
            case "filter":
                ...
                List<MealTo> filteredMeals = MealsUtil.getFilteredTos(mealController.getAll(), MealsUtil.DEFAULT_CALORIES_PER_DAY, startTime, endTime);
    ...
    private LocalTime parseTime(String timeStr) {
        return (timeStr == null || timeStr.isEmpty()) ? null : LocalTime.parse(timeStr);
    }
}
