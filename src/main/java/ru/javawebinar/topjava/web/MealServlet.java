    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action == null ? "all" : action) {
            case "filter":
                ...
                LocalDate endDete = DateTimeUtil.parseLocalDate(request.getParameter("endDate"), LocalDate.now());
                LocalTime endTime = DateTimeUtil.parseLocalTime(request.getParameter("endTime"), LocalTime.MAX);
                request.setAttribute("meals", repository.getBetween(startDate, startTime, endDete, endTime));
