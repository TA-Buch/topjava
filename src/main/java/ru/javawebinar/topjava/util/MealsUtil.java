...
public class MealsUtil {
    public static final List<Meal> MEALS = Arrays.asList(
            ...
            new Meal(1, LocalDateTime.of( 2015, Month.MAY, 30, 10, 0), "Завтрак1", 500),
            new Meal(1, LocalDateTime.of( 2015, Month.MAY, 30, 13, 0), "Обед1", 1000),
            new Meal(1, LocalDateTime.of(2015, Month.MAY, 30, 20, 0), "Ужин1", 500),
            new Meal(1, LocalDateTime.of(2015, Month.MAY, 31, 10, 0), "Завтрак1", 1000),
            new Meal(1, LocalDateTime.of(2015, Month.MAY, 31, 13, 0), "Обед1", 500),
            new Meal(1, LocalDateTime.of(2015, Month.MAY, 31, 20, 0), "Ужин1", 510)
    );
